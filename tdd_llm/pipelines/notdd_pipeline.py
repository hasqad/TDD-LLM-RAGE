"""
No-TDD pipeline — for one sample.
Generates code directly. Auto-generates separate evaluation tests.
"""
...
from ..prompts.code_prompts import (
    CODE_GENERATION_SYSTEM, NOTDD_GENERATION_PROMPT,
...
class SampleResult:
    code: str = ""
    tests_code: str = ""       # auto-generated evaluation tests
...
class NotddPipeline:
    ...
    def generate_tests(self, task: dict, seed: int) -> str:
        """
        Generate evaluation tests independently from the code.
        Uses a high seed offset to ensure independence.
        """
        ...
        raw = self.client.generate(
            ...
            temperature=0.2, seed=seed + 10000,
        )
    ...
    def run_sample(self, task: dict, tests_code: str, seed: int) -> SampleResult:
        ...
        prompt = NOTDD_GENERATION_PROMPT.format(
            task_description=self._description(task),
            function_signature=task["function_signature"],
